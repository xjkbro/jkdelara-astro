---
title: homebay
description: Centralized hub to organize families.
date: 2023-06-20T20:56:09.587Z
image: /project/homebay/irl_cropped.png
feature: true
technologies:
    - React
    - Vite
...
type: project
github: https://github.com/xjkbro/homebay
---
...
I had a Raspberry Pi 4 collecting dust and a small touchscreen with no purpose. Rather than let them sit unused, I built a practical tool that improves our family's daily routine by keeping essential information close and visible.
...
![IRL](/project/homebay/cover.png)
<!-- ![IRL](/project/homebay/IRL_Cropped.png) -->
